...
$sql="INSERT INTO payment () VALUES ('$_POST[rno]','$_POST[amt]'-'$_POST[pamt]','$_POST[amt]','$_POST[s]','$_POST[pd]','$_POST[pid]','$_POST[pamt]')";
...
echo "INVALID PATIENT RECORD"; 
 $query = "select * from payment"; // Fetch all the records from the table customer
    $result = mysqli_query($conn, $query);
?>
...
<section class="tocenter">
	<a href="end.html" class="delbtn">PROCESSING DONE!</a>
</section>
